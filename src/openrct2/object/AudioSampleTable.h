...
namespace OpenRCT2
{
    ...
    private:
        ...
        // OPENRCT2MINI: cut 28. Mutable so GetSample(idx) const can lazy-load and cache
        // the IAudioSource* on first play. Source ownership stays with the audio context;
        // we only cache the pointer.
