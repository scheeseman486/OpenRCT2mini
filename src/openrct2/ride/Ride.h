...
#include <limits>
#include <memory>
// OPENRCT2MINI: cut 33. <span> is C++20; use the project polyfill.
#include "../core/Span.hpp"
#include <string_view>
// OPENRCT2MINI: cut 36. std::to_array polyfill (used directly in this header).
...
// OPENRCT2MINI: cut 36. Explicit <Breakdown> so the C++17 polyfill matches.
constexpr auto kAllBreakdownTypes = std::array<Breakdown, 8>{{
