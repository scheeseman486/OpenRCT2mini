...
#include <mutex>
#include <optional>
// OPENRCT2MINI: cut 36. <stop_token> is C++20-only and not actually used by
// this header — the cancellation channel is std::atomic_bool. Drop the
// include so we build on GCC 8.3 (no C++20 stdlib).
#include <thread>
#include <type_traits>
#include <vector>
