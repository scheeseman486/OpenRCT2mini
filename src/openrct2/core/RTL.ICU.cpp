...
// OPENRCT2MINI: cut 34. Skip the ICU RTL reshaper under DISABLE_ICU. RTL
// reshaping (Arabic, Hebrew) isn't part of the device's target language scope
// (English / Western European only). The fallback `FixRTL` defined below
...
#elif defined(DISABLE_ICU) && !defined(_WIN32)
    // OPENRCT2MINI: cut 34. No-op fallback — return input unchanged.
    #include "RTL.h"
