...
// OPENRCT2MINI: cut 33. `using enum TrackElemType;` removed for C++17;
            // bare enumerator names below are qualified via this regex pass.
            std::array<std::remove_reference<TrackPaintFunction>::type*, EnumValue(TrackElemType::count)> fns{};
            // OPENRCT2MINI: cut 33. std::array::fill became constexpr in C++20;
            // C++17 needs a manual loop in constexpr context.
            for (auto& f : fns) f = TrackPaintFunctionDummy;
            fns[EnumValue(TrackElemType::flat)] = trackPaintFlat;
            fns[EnumValue(TrackElemType::up25)] = trackPaintUp25;
            fns[EnumValue(TrackElemType::up60)] = trackPaintUp60;
            fns[EnumValue(TrackElemType::flatToUp25)] = trackPaintFlatToUp25;
            fns[EnumValue(TrackElemType::up25ToUp60)] = trackPaintUp25ToUp60;
            fns[EnumValue(TrackElemType::up60ToUp25)] = trackPaintUp60ToUp25;
            fns[EnumValue(TrackElemType::up25ToFlat)] = trackPaintUp25ToFlat;
            fns[EnumValue(TrackElemType::down25)] = trackPaintDown25;
            fns[EnumValue(TrackElemType::down60)] = trackPaintDown60;
            fns[EnumValue(TrackElemType::flatToDown25)] = trackPaintFlatToDown25;
            fns[EnumValue(TrackElemType::down25ToDown60)] = trackPaintDown25ToDown60;
            fns[EnumValue(TrackElemType::down60ToDown25)] = trackPaintDown60ToDown25;
            fns[EnumValue(TrackElemType::down25ToFlat)] = trackPaintDown25ToFlat;
            fns[EnumValue(TrackElemType::leftQuarterTurn5Tiles)] = trackPaintLeftQuarterTurn5Tiles;
            fns[EnumValue(TrackElemType::rightQuarterTurn5Tiles)] = trackPaintRightQuarterTurn5Tiles;
            fns[EnumValue(TrackElemType::flatToLeftBank)] = trackPaintFlatToLeftBank;
            fns[EnumValue(TrackElemType::flatToRightBank)] = trackPaintFlatToRightBank;
            fns[EnumValue(TrackElemType::leftBankToFlat)] = trackPaintLeftBankToFlat;
            fns[EnumValue(TrackElemType::rightBankToFlat)] = trackPaintRightBankToFlat;
            fns[EnumValue(TrackElemType::bankedLeftQuarterTurn5Tiles)] = trackPaintBankedLeftQuarterTurn5Tiles;
            fns[EnumValue(TrackElemType::bankedRightQuarterTurn5Tiles)] = trackPaintBankedRightQuarterTurn5Tiles;
            fns[EnumValue(TrackElemType::leftBankToUp25)] = trackPaintLeftBankToUp25;
            fns[EnumValue(TrackElemType::rightBankToUp25)] = trackPaintRightBankToUp25;
            fns[EnumValue(TrackElemType::up25ToLeftBank)] = trackPaintUp25ToLeftBank;
            fns[EnumValue(TrackElemType::up25ToRightBank)] = trackPaintUp25ToRightBank;
            fns[EnumValue(TrackElemType::leftBankToDown25)] = trackPaintLeftBankToDown25;
            fns[EnumValue(TrackElemType::rightBankToDown25)] = trackPaintRightBankToDown25;
            fns[EnumValue(TrackElemType::down25ToLeftBank)] = trackPaintDown25ToLeftBank;
            fns[EnumValue(TrackElemType::down25ToRightBank)] = trackPaintDown25ToRightBank;
            fns[EnumValue(TrackElemType::leftBank)] = trackPaintLeftBank;
            fns[EnumValue(TrackElemType::rightBank)] = trackPaintRightBank;
            fns[EnumValue(TrackElemType::sBendLeft)] = trackPaintSBendLeft;
            fns[EnumValue(TrackElemType::sBendRight)] = trackPaintSBendRight;
            fns[EnumValue(TrackElemType::leftQuarterTurn3Tiles)] = trackPaintLeftQuarterTurn3Tiles;
            fns[EnumValue(TrackElemType::rightQuarterTurn3Tiles)] = trackPaintRightQuarterTurn3Tiles;
            fns[EnumValue(TrackElemType::leftBankedQuarterTurn3Tiles)] = trackPaintLeftBankedQuarterTurn3Tiles;
            fns[EnumValue(TrackElemType::rightBankedQuarterTurn3Tiles)] = trackPaintRightBankedQuarterTurn3Tiles;
            fns[EnumValue(TrackElemType::brakes)] = trackPaintBrakes;
            fns[EnumValue(TrackElemType::onRidePhoto)] = trackPaintOnRidePhoto;
            fns[EnumValue(TrackElemType::up90)] = trackPaintUp90;
            fns[EnumValue(TrackElemType::down90)] = trackPaintDown90;
            fns[EnumValue(TrackElemType::up60ToUp90)] = trackPaintUp60ToUp90;
            fns[EnumValue(TrackElemType::down90ToDown60)] = trackPaintDown90ToDown60;
            fns[EnumValue(TrackElemType::up90ToUp60)] = trackPaintUp90ToUp60;
            fns[EnumValue(TrackElemType::down60ToDown90)] = trackPaintDown60ToDown90;
            fns[EnumValue(TrackElemType::leftEighthToDiag)] = trackPaintLeftEighthToDiag;
            fns[EnumValue(TrackElemType::rightEighthToDiag)] = trackPaintRightEighthToDiag;
            fns[EnumValue(TrackElemType::leftEighthToOrthogonal)] = trackPaintLeftEighthToOrthogonal;
            fns[EnumValue(TrackElemType::rightEighthToOrthogonal)] = trackPaintRightEighthToOrthogonal;
            fns[EnumValue(TrackElemType::leftEighthBankToDiag)] = trackPaintLeftEighthBankToDiag;
            fns[EnumValue(TrackElemType::rightEighthBankToDiag)] = trackPaintRightEighthBankToDiag;
            fns[EnumValue(TrackElemType::leftEighthBankToOrthogonal)] = trackPaintLeftEighthBankToOrthogonal;
            fns[EnumValue(TrackElemType::rightEighthBankToOrthogonal)] = trackPaintRightEighthBankToOrthogonal;
            fns[EnumValue(TrackElemType::diagFlat)] = trackPaintDiagFlat;
            fns[EnumValue(TrackElemType::diagUp25)] = trackPaintDiagUp25;
            fns[EnumValue(TrackElemType::diagUp60)] = trackPaintDiagUp60;
            fns[EnumValue(TrackElemType::diagFlatToUp25)] = trackPaintDiagFlatToUp25;
            fns[EnumValue(TrackElemType::diagUp25ToUp60)] = trackPaintDiagUp25ToUp60;
            fns[EnumValue(TrackElemType::diagUp60ToUp25)] = trackPaintDiagUp60ToUp25;
            fns[EnumValue(TrackElemType::diagUp25ToFlat)] = trackPaintDiagUp25ToFlat;
            fns[EnumValue(TrackElemType::diagDown25)] = trackPaintDiagDown25;
            fns[EnumValue(TrackElemType::diagDown60)] = trackPaintDiagDown60;
            fns[EnumValue(TrackElemType::diagFlatToDown25)] = trackPaintDiagFlatToDown25;
            fns[EnumValue(TrackElemType::diagDown25ToDown60)] = trackPaintDiagDown25ToDown60;
            fns[EnumValue(TrackElemType::diagDown60ToDown25)] = trackPaintDiagDown60ToDown25;
            fns[EnumValue(TrackElemType::diagDown25ToFlat)] = trackPaintDiagDown25ToFlat;
            fns[EnumValue(TrackElemType::diagFlatToLeftBank)] = trackPaintDiagFlatToLeftBank;
            fns[EnumValue(TrackElemType::diagFlatToRightBank)] = trackPaintDiagFlatToRightBank;
            fns[EnumValue(TrackElemType::diagLeftBankToFlat)] = trackPaintDiagLeftBankToFlat;
            fns[EnumValue(TrackElemType::diagRightBankToFlat)] = trackPaintDiagRightBankToFlat;
            fns[EnumValue(TrackElemType::diagLeftBankToUp25)] = trackPaintDiagLeftBankToUp25;
            fns[EnumValue(TrackElemType::diagRightBankToUp25)] = trackPaintDiagRightBankToUp25;
            fns[EnumValue(TrackElemType::diagUp25ToLeftBank)] = trackPaintDiagUp25ToLeftBank;
            fns[EnumValue(TrackElemType::diagUp25ToRightBank)] = trackPaintDiagUp25ToRightBank;
            fns[EnumValue(TrackElemType::diagLeftBankToDown25)] = trackPaintDiagLeftBankToDown25;
            fns[EnumValue(TrackElemType::diagRightBankToDown25)] = trackPaintDiagRightBankToDown25;
            fns[EnumValue(TrackElemType::diagDown25ToLeftBank)] = trackPaintDiagDown25ToLeftBank;
            fns[EnumValue(TrackElemType::diagDown25ToRightBank)] = trackPaintDiagDown25ToRightBank;
            fns[EnumValue(TrackElemType::diagLeftBank)] = trackPaintDiagLeftBank;
            fns[EnumValue(TrackElemType::diagRightBank)] = trackPaintDiagRightBank;
            fns[EnumValue(TrackElemType::leftFlyerTwistDown)] = trackPaintLeftFlyerTwistDown;
            fns[EnumValue(TrackElemType::rightFlyerTwistDown)] = trackPaintRightFlyerTwistDown;
            fns[EnumValue(TrackElemType::multiDimInvertedFlatToDown90QuarterLoop)] = trackPaintMultiDimInvertedFlatToDown90QuarterLoop;
            fns[EnumValue(TrackElemType::blockBrakes)] = trackPaintBlockBrakes;
            fns[EnumValue(TrackElemType::multiDimInvertedUp90ToFlatQuarterLoop)] = trackPaintMultiDimInvertedUp90ToFlatQuarterLoop;
            fns[EnumValue(TrackElemType::diagBrakes)] = trackPaintDiagBrakes;
            fns[EnumValue(TrackElemType::diagBlockBrakes)] = trackPaintDiagBlockBrakes;
            return fns;
        }();
} // namespace OpenRCT2::MultiDimensionRCInverted
