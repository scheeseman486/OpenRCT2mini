...
namespace OpenRCT2::WoodenRC
{
    ...
    template<bool isClassic, const std::array<WoodenTrackSection, kNumOrthogonalDirections>& imageIds>
    ...
    /** rct2: 0x008AC808 */
    template<bool isClassic, const std::array<std::array<WoodenTrackSection, kNumOrthogonalDirections>, 3>& imageIds>
    ...
    template<bool isClassic, const std::array<std::array<WoodenTrackSection, kNumOrthogonalDirections>, 5>& imageIds>
    ...
    /** rct2: 0x008ACB38 */
    template<bool isClassic, const std::array<std::array<WoodenTrackSection, kNumOrthogonalDirections>, 2>& imageIds>
    ...
    /** rct2: 0x008AC998 */
    template<bool isClassic, const std::array<std::array<WoodenTrackSection, kNumOrthogonalDirections>, 4>& imageIds>
