...
namespace OpenRCT2::Ui::Windows
{
    ...
    // clang-format off
    static const auto kMainWidgets = makeWidgets(
    ...
    static const auto _windowAboutRCT2Widgets = makeWidgets(kMainWidgets);

    static const std::span<const Widget> _windowAboutPageWidgets[] = {
