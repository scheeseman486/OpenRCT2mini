...
namespace OpenRCT2::Ui::Windows
{
    ...
    // clang-format off
    static const auto kMainStaffWidgets = makeWidgets(
    ...
    static const auto _staffOverviewWidgets = makeWidgets(
        kMainStaffWidgets,
    ...
    //0x9AF910
    static const auto _staffOptionsWidgets = makeWidgets(
        kMainStaffWidgets,
    ...
    // 0x9AF9F4
    static const auto _staffStatsWidgets = makeWidgets(
        kMainStaffWidgets
    );
    // clang-format on

    static const std::span<const Widget> window_staff_page_widgets[] = {
