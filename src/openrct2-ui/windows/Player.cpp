...
#pragma region Widgets
    ...
    static const auto kCommonPlayerWidgets = makeWidgets(
    ...
    static const auto window_player_overview_widgets = makeWidgets(
    ...
    static const auto window_player_statistics_widgets = makeWidgets(
        kCommonPlayerWidgets
    );

    static const std::span<const Widget> window_player_page_widgets[] = {
