...
namespace OpenRCT2::Ui::Windows
{
    ...
    // OPENRCT2MINI: cut 29. Was 734 — overflows 640 px screens. Shrunk to fit
    // exactly. The layout code at L435 (`right = width - GetPreviewPaneWidth()
    // - 2*kPadding`) is screen-driven, so the scenario list re-flows correctly
    // — only the constexpr default needed to change.
    static constexpr ScreenSize kWindowSize = { 640, 384 };
    ...
    // clang-format off
    static const auto _scenarioSelectWidgets = makeWidgets(
