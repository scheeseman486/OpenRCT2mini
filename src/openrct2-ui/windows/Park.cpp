...
#pragma region Widgets
    ...
    // clang-format off
    static const auto makeParkWidgets = [](int16_t width) {
        return makeWidgets(
    ...
    static const auto _entranceWidgets = makeWidgets(
        makeParkWidgets(230),
    ...
    static const auto _ratingWidgets = makeWidgets(
        makeParkWidgets(255)
    );

    static const auto _guestsWidgets = makeWidgets(
        makeParkWidgets(255)
    );

    static const auto _priceWidgets = makeWidgets(
        makeParkWidgets(230),
    ...
    static const auto _statsWidgets = makeWidgets(
        makeParkWidgets(230)
    );

    static const auto _objectiveWidgets = makeWidgets(
        makeParkWidgets(230),
        makeWidget({7, 207}, {216, 14}, WidgetType::button, WindowColour::secondary, STR_ENTER_NAME_INTO_SCENARIO_CHART) // enter name
    );

    static const auto _awardsWidgets = makeWidgets(
        makeParkWidgets(230)
    );
