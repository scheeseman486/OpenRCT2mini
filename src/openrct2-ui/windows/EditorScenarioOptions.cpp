...
#pragma region Widgets
    ...
    // clang-format off
    static const auto makeOptionsWidgets = [](StringId title, ScreenSize size) {
        return makeWidgets(
    ...
    static const auto window_editor_scenario_options_objective_widgets = makeWidgets(
    ...
    static const auto window_editor_scenario_options_scenario_details_widgets = makeWidgets(
    ...
    static const auto window_editor_scenario_options_financial_widgets = makeWidgets(
    ...
    static const auto window_editor_scenario_options_guests_widgets = makeWidgets(
    ...
    static const auto window_editor_scenario_options_land_widgets = makeWidgets(
    ...
    static const auto window_editor_scenario_options_rides_widgets = makeWidgets(
    ...
    static const std::span<const Widget> window_editor_scenario_options_widgets[] = {
