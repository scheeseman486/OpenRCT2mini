...
namespace OpenRCT2::Ui::Windows
{
    ...
    // clang-format off
    static const auto kMainGuestWidgets = makeWidgets(
    ...
    static const auto _guestWindowWidgetsOverview = makeWidgets(
        kMainGuestWidgets,
    ...
    static const auto _guestWindowWidgetsStats = makeWidgets(
        kMainGuestWidgets,
    ...
    static const auto _guestWindowWidgetsRides = makeWidgets(
        kMainGuestWidgets,
    ...
    static const auto _guestWindowWidgetsFinance = makeWidgets(
        kMainGuestWidgets
    );

    static const auto _guestWindowWidgetsThoughts = makeWidgets(
        kMainGuestWidgets,
        makeWidget({ 3, 45 }, { 186, 10 }, WidgetType::label,  WindowColour::secondary, STR_GUEST_RECENT_THOUGHTS_LABEL)
    );

    static const auto _guestWindowWidgetsInventory = makeWidgets(
        kMainGuestWidgets,
        makeWidget({ 3, 45 }, { 186, 10 }, WidgetType::label,  WindowColour::secondary, STR_CARRYING)
    );

    static const auto _guestWindowWidgetsDebug = makeWidgets(
        kMainGuestWidgets
    );

    static const std::span<const Widget> _guestWindowPageWidgets[] = {
    ...
    public:
        ...
        {
            if (isToolActiveForNumber(classification, number))
                ToolCancel();
        }
