...
#pragma region Widgets
    ...
    static const auto makeFinancesWidgets = [](StringId title, ScreenSize resizeSize, ScreenSize frameSize) {
        return makeWidgets(
    ...
    static const auto _windowFinancesSummaryWidgets = makeWidgets(
    ...
    static const auto _windowFinancesResearchWidgets = makeWidgets(
    ...
    static const std::span<const Widget> _windowFinancesPageWidgets[] = {
